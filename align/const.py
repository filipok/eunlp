...
PAGE = unicode('<!DOCTYPE html>\n'
               ...
               'jsalign/0.8/jsalign.js">'
               '</script>\n'
               '<script class="links" type="text/javascript" '
               'src="https://s3.eu-central-1.amazonaws.com/rangy/'
               'rangy-1.3.0/rangy-core.js"></script>\n'
               '<link rel="stylesheet" '
               'href="https://maxcdn.bootstrapcdn.com/'
               'bootswatch/3.3.6/cosmo/bootstrap.min.css">\n'
               '<link class="links" rel="stylesheet" type="text/css" href'
               '="https://s3.eu-central-1.amazonaws.com/'
               'jsalign/0.8/jsalign.css">\n'
               ...
               '<div class="demo"><a class="btn btn-default btn-xs"'
               ' href="#"><span class="glyphicon '
               'glyphicon-move"></a></span> Cut the segments you want to '
               'move</div>\n'
               '<div class="demo"><a class="btn btn-primary btn-xs"'
               ' href="#"><span class="glyphicon '
               'glyphicon-paste"></a></span> Paste the segments you want to '
               'move below the current segment</div>\n'
               ...
               '  <tr class="main-row">\n'
               '    <td id="source-col"  ondrop="drop(event)" '
               'ondragover="allowDrop(event)">\n'
               '{{s_cells}}'
               '\n    </td>\n'
               '    <td id="target-col"  ondrop="drop(event)" '
               'ondragover="allowDrop(event)">\n'
               '{{t_cells}}'
               '\n    </td>\n'
               '  </tr>\n'
